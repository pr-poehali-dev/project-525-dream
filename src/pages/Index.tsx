...
const Index = () => {
  ...
  const routePoints: RoutePoint[] = [
    {
      number: "01",
      title: "Площадь Лемаева",
      description: "Стартовая точка маршрута. Главная площадь Нижнекамска, названная в честь Николая Лемаева — выдающегося руководителя нефтехимической промышленности города.",
      category: "Площадь",
      time: "9:00",
    ...
    },
    {
      ...
      description: "Любимое место отдыха горожан с аллеями, скульптурами и фонтанами. Парк хранит память о тех, кто строил и развивал нефтехимическую столицу Татарстана.",
      category: "Парк",
      time: "11:00",
